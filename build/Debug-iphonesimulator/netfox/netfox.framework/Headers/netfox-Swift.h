...
#ifndef NETFOX_SWIFT_H
#define NETFOX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="netfox",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM(NSInteger, ENFXGesture, closed) {
  ENFXGestureShake = 0,
  ENFXGestureCustom = 1,
};
...
@interface NFX (SWIFT_EXTENSION(netfox)) <UIAdaptivePresentationControllerDelegate>
...
SWIFT_CLASS("_TtC6netfox12NFXHTTPModel")
...
@interface NFXProtocol (SWIFT_EXTENSION(netfox)) <NSURLSessionDataDelegate>
