...
#ifndef PAGINATEDTABLEVIEW_SWIFT_H
#define PAGINATEDTABLEVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PaginatedTableView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC18PaginatedTableView18PaginatedTableView")
...
@interface PaginatedTableView (SWIFT_EXTENSION(PaginatedTableView)) <UITableViewDataSourcePrefetching>
- (void)tableView:(UITableView * _Nonnull)tableView prefetchRowsAtIndexPaths:(NSArray<NSIndexPath *> * _Nonnull)indexPaths;
@end

@class UIScrollView;

@interface PaginatedTableView (SWIFT_EXTENSION(PaginatedTableView))
...
@interface PaginatedTableView (SWIFT_EXTENSION(PaginatedTableView)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_PROTOCOL("_TtP18PaginatedTableView28PaginatedTableViewDataSource_")
...
SWIFT_PROTOCOL("_TtP18PaginatedTableView26PaginatedTableViewDelegate_")
