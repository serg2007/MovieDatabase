...
#ifndef MOVIEDATABASE_SWIFT_H
#define MOVIEDATABASE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MovieDatabase",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13MovieDatabase11AppDelegate")
...
SWIFT_CLASS("_TtC13MovieDatabase19DetailImageItemCell")
@interface DetailImageItemCell : UITableViewCell
...
SWIFT_CLASS("_TtC13MovieDatabase18DetailTextItemCell")
@interface DetailTextItemCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified mainTextLabel;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC13MovieDatabase21DetailsViewController")
...
@interface DetailsViewController (SWIFT_EXTENSION(MovieDatabase)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC13MovieDatabase9MovieCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified gentreLabel;
...
SWIFT_CLASS("_TtC13MovieDatabase13SceneDelegate")
...
SWIFT_CLASS("_TtC13MovieDatabase14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UISearchBar * _Null_unspecified searchBar;
@property (nonatomic, weak) IBOutlet PaginatedTableView * _Null_unspecified tableView;
- (void)viewDidLoad;
...
@interface ViewController (SWIFT_EXTENSION(MovieDatabase)) <UISearchBarDelegate>
- (void)searchBarTextDidBeginEditing:(UISearchBar * _Nonnull)searchBar;
- (void)searchBar:(UISearchBar * _Nonnull)searchBar textDidChange:(NSString * _Nonnull)searchText;
@end


@interface ViewController (SWIFT_EXTENSION(MovieDatabase)) <PaginatedTableViewDataSource, PaginatedTableViewDelegate>
- (void)loadMore:(NSInteger)pageNumber :(NSInteger)pageSize onSuccess:(void (^ _Nullable)(BOOL))onSuccess onError:(void (^ _Nullable)(NSError * _Nonnull))onError;
